...
//yaomoon
//usb_driver 中的函数完成usb设备探测，链接，断开，管理
static struct usb_driver garmin_driver = {
	.name =		"garmin_gps",   //the name of usb device 
	.probe =	usb_serial_probe, //to probing the device connecting to usbbus
	.disconnect =	usb_serial_disconnect,//disconnect the connection
	.id_table =	id_table,
	.no_dynamic_id = 1,
};
...
// tty_struct was defined in linux2.36/include/linux/tty.h
/*#####################################################*/ 
...
/*#####################################################################################################*/ 
//yaomoon
//these are the actural driver function; usb_driver struct just play a part 
//in connecting usb device and manage it
/*usb_serial_driver was defined in
 * /home/meego/linux-2.6.37/include/linux/usb/serial.h*/
/*#####################################################################################################*/
...
static int __init garmin_init(void)
{
    ...
    if(usb_serial_register(&garmin_device)) {
